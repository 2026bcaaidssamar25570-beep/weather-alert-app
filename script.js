// 🔊 अलार्म सायरन साउंड सेट करना
const alarmSound = new Audio("https://google.com");

let searchHistory = [];

// 🌍 ऑफलाइन स्मार्ट डेटाबेस (इसमें दुनिया के मुख्य शहरों का लाइव डिज़ास्टर डेटा सेट है)
    ...
    if ('Notification' in window) {
        Notification.requestPermission().then(permission => {
            if (permission === 'granted') {
                alert('🎉 Emergency System Connected and Activated!');
            }
        });
    }
});
...
document.getElementById('search-btn').addEventListener('click', () => {
    ...
    if (localDisasterDatabase[cityInput]) {
        ...
        alert("City not found! For offline testing, search for: Mumbai, Delhi, Shimla, Jaipur, London, or New York.");
    }
});
...
document.getElementById('gps-btn').addEventListener('click', () => {
    ...
    setTimeout(() => {
        ...
        alert("📍 Your Current Location Detected Successfully!");
    }, 1000);
});
